#!/usr/bin/env python3
"""
DPS Logger serial port diagnostics.

Checks that the configured serial port exists,
permissions allow access, and the port can be opened
using pyserial.

Primary target: /dev/ttyLOG
Optional: /dev/ttySIM
"""
