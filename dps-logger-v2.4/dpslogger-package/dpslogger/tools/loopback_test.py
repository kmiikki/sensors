#!/usr/bin/env python3
"""
Serial loopback diagnostic for DPS Logger.

Tests raw serial communication by sending frames
through TX and verifying identical data on RX.

This verifies the serial path but does not test
the DPS sensor protocol itself.
"""
